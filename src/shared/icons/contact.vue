<template>
  <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15" :class="[`fill-${props.defaultColor}`, ` group-hover:fill-${appStore.primaryColor} w-6 h-7`, { [`fill-${appStore.primaryColor}`]: $route.query.nav === 'contact' }]">
    <path
